...
#[test]
fn corpus_net_udp() {
    let sem = analyze_file("../../protospec/examples/net/udp.wire")
...
#[test]
fn corpus_net_tcp() {
    let sem = analyze_file("../../protospec/examples/net/tcp.wire")
...
fn corpus_net_ethernet() {
    let sem = analyze_file("../../protospec/examples/net/ethernet.wire")
...
fn corpus_test_bits_groups() {
    let sem = analyze_file("../../protospec/examples/test/bits_groups.wire")
...
fn corpus_quic_frames() {
    let sem = analyze_file("../../protospec/examples/quic/frames.wire")
...
#[test]
fn corpus_ble_att() {
    let sem = analyze_file("../../protospec/examples/ble/att.wire")
...
fn corpus_mpquic_path() {
    let sem = analyze_file("../../protospec/examples/mpquic/path.wire")
